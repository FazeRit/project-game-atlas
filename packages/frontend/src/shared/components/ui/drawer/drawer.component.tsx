...
>(({ className, children, ...props }, ref) => (
  <DrawerPortal>
    ...
    <DrawerPrimitive.Content
      ref={ref}
      className={cn(
        "bottom-0 z-50 fixed inset-x-0 flex flex-col bg-zinc-900 mt-24 border border-zinc-700 rounded-t-[10px] h-auto text-gray-100",
        className
      )}
      {...props}
    >
      <div className="bg-zinc-700 mx-auto mt-4 rounded-full w-[100px] h-2" />
      {children}
    </DrawerPrimitive.Content>
  </DrawerPortal>
))
