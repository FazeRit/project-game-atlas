...
import { IPersonalLibraryGameListFiltersProps } from "../../model/interfaces/personal-library-game-list-filters.interface";
import { GenresFilter } from "@/entities/genre";
import { KeywordsFilter } from "@/entities/keyword";

export const PersonalLibraryGameListFilters = memo((props: IPersonalLibraryGameListFiltersProps) => {
    const {
        availableGenres,
        selectedGenres,
        onGenresChange,
